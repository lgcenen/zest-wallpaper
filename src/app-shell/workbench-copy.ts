...
const zhCnCopy: WorkbenchCopy = {
  ...
  applyLive: "已在桌面生效",
  applyFailed: "应用失败",
  scopeNote: "GUI 偏好保存在本地；Scene 外部 assets 挂载写入原生设置，仅影响 Scene 资源查找，不改动 Video / Web 主链。",
...
const englishCopy: WorkbenchCopy = {
  ...
  applyLive: "Live on desktop",
  applyFailed: "Apply failed",
  scopeNote:
    "GUI preferences stay local. The Scene external assets mount is stored natively and only affects Scene resource lookup, not the Video / Web runtime path.",
