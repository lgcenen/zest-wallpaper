...
#[path = "scene_effect_draw_runtime_service.rs"]
...
pub(super) struct NativeSceneMetalRenderer {
    ...
    pub(super) texture_cache: BTreeMap<String, Retained<ProtocolObject<dyn MTLTexture>>>,
    pub(super) texture_resolution_cache: BTreeMap<String, Phase10TextureMetrics>,
    pub(super) text_texture_cache: BTreeMap<String, Retained<ProtocolObject<dyn MTLTexture>>>,
    pub(super) phase10_targets: Phase10RenderTargetStores,
    pub(super) video_sources: BTreeMap<u32, NativeSceneVideoSource>,
    pub(super) mdl_cache: BTreeMap<PathBuf, SceneMdlDocument>,
    pub(super) compiled_shader_variants:
...
pub(super) enum Phase10BackgroundSourceKind {
    Phase10Visual,
    Visual,
    Text,
}
...
#[cfg(target_os = "macos")]
pub(super) struct Phase10BackgroundLayer {
    pub(super) quad: SceneRenderQuad,
    pub(super) blend_mode: SceneRenderBlendMode,
...
impl NativeSceneMetalRenderer {
    ...
    fn draw_phase10_visual(
        ...
        if let Some(puppet_path) = visual.puppet_path.as_ref() {
            ...
            for resolved_pass in &passes {
                ...
                let shader_defines = phase10_pass_shader_defines(resolved_pass);
                scene_effect_draw_runtime_service::draw_phase10_mesh(
                    self,
                    encoder,
                    projection,
                    visual,
    ...
    fn encode_phase10_pass(
        ...
        scene_effect_draw_runtime_service::encode_phase10_pass(
            self,
            command_buffer,
            target,
            pass,
    ...
    fn draw_phase10_fullscreen_texture(
        ...
        scene_effect_draw_runtime_service::draw_phase10_fullscreen_texture(
            self,
            encoder,
            texture,
            tint,
    ...
    fn draw_phase10_fullscreen_pass(
        ...
        scene_effect_draw_runtime_service::draw_phase10_fullscreen_pass(
            self,
            encoder,
            pipeline,
            pass_textures,
